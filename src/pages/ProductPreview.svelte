<script>
    ...
    import LoadingCard from '../components/LoadingState.svelte';
  ...
  {:else}
  <div class="grid bg-white m-10">
    <a href="/">
        <button class="bg-gray-500 text-white py-2 px-4 rounded"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
